	...
	public function render() {
		...
		<div class="wrap">
			...
			<ul>
				...
				<li><?php esc_html_e( 'Not all data types and settings in ACF have an equivalent in Meta Box. The plugin will try to migrate as much as it can. But for such data or settings, the plugin will ignore. This includes: link, accordion, clone field types and complex location/conditional logic rules.', 'mb-acf-integration' ) ?></li>
				<li>
					<?php esc_html_e( 'The plugin will attempt to migrate both field groups and custom fields data to Meta Box. You might need some premium extensions like Meta Box Builder for all the data type, such as:', 'mb-acf-migration' ) ?>
					<ul>
						...
						<li><a href="https://metabox.io/plugins/mb-blocks/" target="_blank">MB Blocks</a>: <?php esc_html_e( 'For handling custom fields for blocks.', 'mb-acf-migration' ) ?></li>
					</ul>
				</li>
				<li><?php esc_html_e( 'You need to update the code to output fields data on the frontend to make it work with Meta Box.', 'mb-acf-integration' ) ?></li>
			</ul>
			<div id="status"></div>
		</div>
		<?php
